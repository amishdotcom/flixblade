...
<?php
echo "<font color=\"red\" size=\"18\" face=\"Arial\">Cybertronics Sitemap Generator</font>";echo "<font color=\"green\">An Amish Dotcom Exclusive</font>";echo "<font color=\"green\">   (Confidential Tool) (For flixblade)</font>";
echo "<br \>";
echo "<br \>";
echo "<br \>";
...
require('../access.php');
?>
<form action="sitemap-call.php">
 <input type="submit" value="Click to Generate the Sitemap">
</form>
